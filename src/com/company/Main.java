...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        //5.2 - uncomment line below
//        System.out.print("Enter a string: ");
        // 3.1.1 - uncomment the line below
...
//        int number = userString - 1;
        ...
        //8.1 - Uncomment 4 lines below - comment out lines 30, 32, 43 & 66
...
//        System.out.println(answer);
        ...
        /*  9
        Awesome, so just like with the string we put in at first it recognized exactly what we put in and worked our
        equation.  What happens if we input a letter, string or even a decimal number instead on a whole number?
        Try it and find out.
        */
